...
def _reading(has_real_problem, stage=None, system_type=None, summary="no problem found", action="none"):
    return SpecialistReading(
        has_real_problem=has_real_problem, stage=stage, system_type=system_type,
...
async def test_supervisor_full_stack_ord_88213():
    ...
    # side has a real, confirmed problem -- single-cause branch, high
    # confidence.
    assert diagnosis.confidence == "high"
